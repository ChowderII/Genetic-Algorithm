...
public class Queens {
	...
	public static void simulate(int generations, int size, int dimension) {
		...
		Population crampage = new Population(size, dimension);
		...
		Individual result = crampage.getFittest();
		System.out.println("La solution optimale comporte la solution suivante : " + result.toString());
		System.out.println("Cette solution comporte : "+ result.getFitness() + " paires de reines qui s'attaquent.");
	}
